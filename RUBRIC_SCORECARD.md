...
| Technical execution | The build is a self-contained static canvas game with mouse, touch, keyboard, on-screen node controls, first-action grace, phase-specific hint order, default-off audio, deterministic demo route, local verifier, and 71-check browser smoke. | `game.js`, `smoke.html`, `tools/browser-smoke-check.mjs` |
