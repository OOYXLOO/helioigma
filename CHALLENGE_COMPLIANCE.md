...
- Prize target: Best Ode to Alan Turing, one of five total USD 200 winner slots.
...
| Originality | `README.md`, `dev-article-final.md`, and `judge-manifest.json` state the package is a new jam-period static game, not a third-party game template. |
