...
- `smoke.html`: 49 PASS checks including daylight meter, phase objective strip, phase announcer, phase scoring ledger, H-to-Hint behavior, Rotor Trace state, D-to-Demo-Solve, R-to-reset, final status, receipt format, and receipt-verifier link coverage.
...
- Manifest check: `judge-manifest.json` records the USD 200 target, Best Ode to Alan Turing category, 49 expected smoke checks, and stable receipt `SC-4P-2907-62-Y5VFX1`.
