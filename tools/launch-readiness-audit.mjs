...
const mustContain = [
  ...
  ["proof-verifier.html", "receipt-core.js"],
  ["index.html", "receipt-core.js?v=20260615-canvas-priority"],
  ["judge.html", "Playability proof"],
  ["judge.html", "Readable decisions"],
  ["judge.html", "Immediate feedback"],
  ["judge.html", "Finished failure state"],
  ["judge.html", "Verify Receipt"],
  ["judge.html", "proof-verifier.html?receipt=SC-4P-2907-62-Y5VFX1"],
  ["judge.html", "judge-decision-map.json"],
  ["judge.html", "./?nostore=1"],
  ["judge-decision-map.json", "Best Ode to Alan Turing"],
  ...
  ["README.md", "tap node 1 three times until it reads `SOL`"],
  ["README.md", "Daylight is the shared resource"],
  ...
  ["LAUNCH_NOW.md", "SC-4P-2907-62-Y5VFX1"],
  ...
  ["DEV_SUBMISSION_TICKET.md", "Public Gate Before DEV"],
  ["DEV_SUBMISSION_TICKET.md", "published: false"],
  ["DEV_SUBMISSION_TICKET.md", "SC-4P-2907-62-Y5VFX1"],
  ["DEV_SUBMISSION_TICKET.md", "Do not claim Best Google AI Usage"],
  ["DEV_SUBMISSION_TICKET.md", "Post-Publish Receipt"],
  ["DEV_SUBMISSION_TICKET.md", "do not paste the final DEV body while any intended public link still returns 404"],
  ["DEV_SUBMISSION_TICKET.md", "Final DEV editor publish switch is intentional"],
  ["dev-launch-brief.md", "Paste only after public 200s"],
  ["submission-checklist.md", "Confirm every public article link returns HTTP 200"],
  ["proof-verifier.html", "Stable demo replay evidence"],
  ["proof-verifier.html", "Crib dawn, XOR meridian, Carry twilight, and Checksum night"],
