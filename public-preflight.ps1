...
try {
  ...
  Assert-Contains "dev-article-final.md" "published: false"
  Assert-NotContains "dev-article-final.md" "published: true"
  ...
  Assert-Contains "dev-article-final.md" "Helioigma desktop gameplay"
  Assert-Contains "dev-article-final.md" "Helioigma mobile completion receipt"
  ...
  Assert-Contains "FIRST_MINUTE.md" "Local review fast path before public launch"
  Assert-Contains "FIRST_MINUTE.md" "http://127.0.0.1:8781/?demo=1"
  Assert-Contains "JUDGE_REVIEW_CARD.md" "Local review fast path before public launch"
  Assert-Contains "JUDGE_REVIEW_CARD.md" "http://127.0.0.1:8781/smoke.html"
  ...
  Assert-Contains "publish-after-repo.ps1" "Invoke-BrowserSmokeForPush"
  Assert-Contains "publish-after-repo.ps1" "npm run smoke"
  Assert-Contains "publish-after-repo.ps1" "public-preflight.ps1 -Public"
  Assert-Contains "PUBLISHING.md" "PASS browser smoke"
