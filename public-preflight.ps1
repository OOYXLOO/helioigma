...
try {
  ...
  Assert-Contains "dev-article-final.md" "inspectable summary receipt with score, shifts, phase count, and checksum"
  ...
  Assert-Contains "dev-article-final.md" "receipt-checkable loop"
  ...
  Assert-Contains "judge.html" "Receipt-checkable"
  ...
  Assert-Contains "judge.html" "Receipt-Checkable Loop"
