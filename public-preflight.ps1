...
try {
  ...
  Assert-Contains "dev-article-final.md" "If you are judging quickly, the first-minute proof is"
  ...
  Assert-Contains "dev-launch-brief.md" "First-minute proof for rushed judges"
