...
try {
  ...
  Assert-Contains "dev-submit-console.html" "positive reactions can matter only as a tie-breaker"
  Assert-Contains "dev-submit-console.html" "No pressure and no fake engagement"
  ...
  Assert-Contains "submission-checklist.md" "Positive DEV reactions can matter as a challenge tie-breaker"
